...
public class LentInsideInventoryState implements IInventoryState {
    private Inventory inventory;
    private InventoryStateEnum stateEnum = InventoryStateEnum.LENT_INSIDE;

    public LentInsideInventoryState() {
    }

    public LentInsideInventoryState(Inventory inventory)
    {
